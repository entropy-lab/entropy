...
print("\t1. First write and execute\tpython3 node.py\t\tto test single node")
print("\t2. Then execute\t\t\tpython3 workflow.py\tto generate list of parameters")
print("\t3. Write any unresolved input in parameters.json  ")
print("\t4. Execute workflow with\tpython3 -m entropylab.flame.execute ")
