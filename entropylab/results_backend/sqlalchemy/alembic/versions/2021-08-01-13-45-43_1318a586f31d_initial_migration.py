...
def upgrade():
    ...
    sa.Column('driver_type', sa.Enum('Packaged', 'Local', name='drivertype'), nullable=True),
    ...
    op.create_table('ExperimentMetadata',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('experiment_id', sa.Integer(), nullable=True),
    ...
    sa.Column('data_type', sa.Enum('Pickled', 'String', 'Npy', name='resultdatatype'), nullable=True),
    sa.ForeignKeyConstraint(['experiment_id'], ['Experiments.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('ResourcesSnapshots',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('update_time', sa.DATETIME(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('driver_id', sa.Integer(), nullable=True),
    sa.Column('state', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['driver_id'], ['Resources.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
